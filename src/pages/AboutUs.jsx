...
const AboutUs = () => {
  return (
    <>
      <section className="md:w-1/2 flex items-center justify-center" aria-label="Café Interior Image">
        <img
          src={cafeInterior}
      ...
      >
        <div className="max-w-lg bg-beige p-8 shadow-lg rounded-lg transition duration-300 transform hover:scale-105">
          <h2 className="text-3xl font-serif mb-4 text-gray-800" aria-label="About Us Heading">About Us</h2>
          <p className="text-lg font-sans text-gray-700 leading-relaxed" aria-label="About Us Description">
