...
const AboutUsContent = () => {
  return (
    <motion.div
      className="bg-beige p-6 sm:p-8 flex flex-col items-center justify-center shadow-lg rounded-lg transition duration-300 transform hover:scale-105"
    ...
    >
      <div className="max-w-lg">
        <h2 className="text-2xl sm:text-3xl font-serif mb-4 text-gray-800" aria-label="About Us Heading">About Us</h2>
        <p className="text-base sm:text-lg font-sans text-gray-700 leading-relaxed" aria-label="About Us Description">
